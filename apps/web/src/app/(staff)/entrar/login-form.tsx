      ...
      {googleEnabled && (
        <>
          <a
            ...
            className="flex h-11 w-full items-center justify-center gap-2 rounded-lg border border-line-strong bg-surface text-body font-medium text-ink transition-colors hover:bg-hover"
          >
            <GoogleGlyph />
            Entrar com Google
          </a>
